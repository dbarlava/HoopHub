...
class db_operations():
    ...
    def __init__(self, connection=None, host="localhost", user="root", password="CPSC408!", database="HoopHub"):
        if connection is not None:
            # Use provided connection (for flexibility)
            self.connection = connection
        else:
            # Create new connection using same pattern as connector.py
